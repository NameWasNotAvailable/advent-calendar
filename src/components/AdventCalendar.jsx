    ...
    <div className="vtmn-my-3 vtmn-grid vtmn-grid-cols-1 vtmn-gap-5 gt-small-desktop:vtmn-grid-cols-2 gt-small-desktop:vtmn-gap-7">
      {days.map((day, index) => {
        ...
        return (
          <div
            key={index}
            className={` vtmn-max-w-2xl vtmn-rounded-lg vtmn-p-1 b-game-card ${
          ...
          >
            <div
              ...
              style={{
                backgroundImage: konamiCodeActivated
                  ? 'url("/assets/colors.jpg")'
                  : 'url("/assets/Xmas.jpg")',
              }}
            >
              <p className="ribbon">
                <span className="text vtmn-text-4xl vtmn-text-white">
                  {index + 1} December
                </span>
              </p>
            </div>
              ...
              {isCardPassed ? (
                <>
                  {konamiCodeActivated ? (
                    <div className="gif">
                      <iframe
                        src="https://giphy.com/embed/Vuw9m5wXviFIQ"
                        width="480"
                        height="398"
                        frameBorder="0"
                        class="giphy-embed"
                      ...
                      ></iframe>
                      <p>
                        <a href="https://giphy.com/gifs/rickroll-rick-astley-never-gonna-give-you-up-Vuw9m5wXviFIQ"></a>
                      </p>
                    </div>
                  ) : (
                    <>
                      <h3 className="vtmn-px-4 vtmn-mb-3 vtmn-text-4xl">
                        {day.title}
                      </h3>
                      <p className="vtmn-px-4 vtmn-text-md vtmn-text-white">
                        {day.description}
                      </p>
                      <CodeHighlighter
                        language={day.language}
                        code={day.codeSnippet}
                      ...
                      <div className="vtmn-flex">
                        ...
                        <button
                          className="button vtmn-mx-4 vtmn-my-6 vtmn-py-2 vtmn-px-4 vtmn-border vtmn-text-white vtmn-uppercase vtmn-rounded-full"
                          onClick={() => handleCodeCopy(day.codeSnippet, index)}
                        >
                ...
                <>
                  <h3 className="vtmn-px-4 vtmn-mb-3 vtmn-text-4xl">
                    Don't Rushmas Code Quest! ⏳🚀🎄
                  </h3>
                  <p className="vtmn-px-4 vtmn-text-md vtmn-text-white">
                    Couldn't resist the temptation, huh? It's hard waiting for
                    that next dev surprise! May your sneak peeks be forgiven,
                    and your debugging skills shine as bright as Rudolph's nose
                    ✨🦌
                  </p>
                </>
              )}
